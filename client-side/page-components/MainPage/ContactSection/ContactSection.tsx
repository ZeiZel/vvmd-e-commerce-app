			...
			<div className={styles.container}>
				<div className={styles.contacts__wrapper}>
					<div className={styles.contacts__social}>
						<Card className={styles.contacts__form}>
							<form
								className={styles['contacts__form-item']}
							...
							>
								...
								<div className={styles.contacts__register}>
									<Button arrow={'none'} appearance={'primary'}>
										<span>Отправить</span>
									</Button>
									<HTag tag={'h3'}>Или...</HTag>
									<AuthForm className={styles.contacts__register} />
								</div>
							</form>
						</Card>
					</div>
